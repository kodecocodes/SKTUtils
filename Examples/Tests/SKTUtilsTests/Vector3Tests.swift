...
//  SKTUtils
//
//  Created by Luke Groeninger on 11/3/14.
...
class Vector3Tests: XCTestCase {
    ...
    func testAddingVectorAndFloat() {
        XCTAssertEqual(v1 + 2.5, Vector3(x: 102.5, y: 52.5, z:27.5))
    }
    
    func testAddingFloatToVector() {
        v1 += 2.5
        XCTAssertEqual(v1, Vector3(x: 102.5, y: 52.5, z:27.5))
    }
    ...
    func testSubtractingVectorAndFloat() {
        XCTAssertEqual(v1 - 2.5, Vector3(x: 97.5, y: 47.5, z:22.5))
    }
    
    func testSubtractingFloatFromVector() {
        v1 -= 2.5
        XCTAssertEqual(v1, Vector3(x: 97.5, y: 47.5, z:22.5))
    }
    ...
    func testDotProduct() {
        ...
        let r1 = Vector3.dotProduct(v1, v2)
    ...
    func testCrossProduct() {
        ...
        let r1 = Vector3.crossProduct(v1, v2)
